...
('admin1', '공지사항입니다.', '첫 공지 내용입니다.', '관리자1', '2022-12-10 07:30:22', '10'),
('admin2', '탈퇴 회원 명단', 'nnnnn: 부적절한 언어 사용', '관리자2', '2022-12-10 10:40:53', '50'),
('admin3', '신규 종목 출시 예정', '종목 Z, 추후 자세한 공지 예정', '관리자3', '2022-12-10 16:05:12', '100');

INSERT U_BOARD(ID, t_id, code, title, text, time, num)
VALUES
('aaaaa',  null, '005930', '삼성전자 좋아', '삼전 오른다 ㄷㄷ', '2022-12-10 12:20:43', '10'),
('ddddd', null, '207940', '삼바로라고 읽는게 맞음?', '.', '2022-12-10 17:54:11', '3'),
('mmmmm', null, '005380', '나 탈퇴당한줄 알았네;', '아이디 너무 비슷해', '2022-12-10 11:40:22', '50');

INSERT D_BOARD(ID, t_id, text, time)
VALUES
('aaaaa', '2', '아마 ㅇㅇ', '2022-12-10 18:02:43'),
('ddddd', '3', 'ㅋㅋㅋㅋㅋㅋ', '2022-12-10 12:30:11'),
('eeeee', '3', '헷갈릴만하네', '2022-12-10 12:34:40'),
('kkkkk', '1', '드가자', '2022-12-10 12:22:00'),
('mmmmm', '3', '다들 그렇구나ㅋㅋ', '2022-12-10 14:30:20');
